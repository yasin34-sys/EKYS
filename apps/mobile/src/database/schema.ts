// Embedded copy of docs/database/sqlite_schema.sql, kept in sync
// manually. The doc copy is the reviewed/approved source of truth; this
// is what actually ships in the app bundle, since Metro cannot import
// raw .sql files without additional build configuration. If the schema
// changes, both files must be updated together.
...
-- is_free_tier: policy decision, not a license — independent of
-- Entitlement/PackageAccess.
